...
class ShortDesctiptionConsult extends StatefulWidget {
  const ShortDesctiptionConsult({Key? key}) : super(key: key);

  @override
  State<ShortDesctiptionConsult> createState() =>
      _ShortDesctiptionConsultState();
}

class _ShortDesctiptionConsultState extends State<ShortDesctiptionConsult> {
                ...
                children: [
                  ...
                  CustomAppButton(
                    Onclick: shortDescription.text == ""
                        ? null
                        : () {
                            Get.find<AppoinmentService>()
                                .consultCreate(reason: shortDescription.text);
                          },
                    padding: EdgeInsets.only(
