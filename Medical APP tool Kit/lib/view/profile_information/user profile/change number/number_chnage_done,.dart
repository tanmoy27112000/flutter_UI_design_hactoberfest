...
class NumberChangeDoneScreen extends StatefulWidget {
  const NumberChangeDoneScreen({Key? key}) : super(key: key);

  @override
  _NumberChangeDoneScreenState createState() => _NumberChangeDoneScreenState();
}

class _NumberChangeDoneScreenState extends State<NumberChangeDoneScreen> {
  @override
          ...
          child: Column(
            ...
            children: [
              ...
              CustomText(
                ...
                text: "Die Handynummer wurde erfolgreich geändert! ",
